...
### can iterate your modifications quickerwo
temp_counter = 0
...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    for path in from_person:
        ...
        # if temp_counter < 4:
            ...
            # print((parsed_email))
            parsed_email_list = parsed_email.strip().split()
            ...
            # for w in parsed_email_list:
            #     if w in words:
            #         parsed_email_list.remove(w)
            #   
            ### append the text to word_data
            # word_data.append(" ".join(parsed_email_list))
